...
void OperatingSystemLoop(void) {
    if(JACK){
            switch (stateRobot) {
                ...
                case STATE_TRACE:
                    PWMSetSpeedConsigne(-40, MOTEUR_DROITE);
        ...
        void SetNextRobotStateInAutomaticMode() 
            {
                ...
                if (robotState.distanceTelemetreDroit < 20 && robotState.distanceTelemetreGauche < 20)
                    ...
                    positionObstacle = OBSTACLE_EN_FACE;
                else if (robotState.distanceTelemetreDroit2 < 20 || robotState.distanceTelemetreGauche2 < 20)
